/**********************************************************************************************
* OpenCV-3.0.0 environment used.

* Eliminate some interferences with colors that are close to RED or GREEN, 
  by reduce the brightness of the image.

* Distinguish RED or GREEN, using the Cr component of the YCrCb color space.

* Eliminate some interferences in motion, such as car headlight,
  by compare the front and rear frames to see whether the tracking areas is intersected.

* I'm so lazy that I directly duplicate two functions with same code to detect RED and GREEN,
  this way is not recommended strongly, try to integrate them.
**********************************************************************************************/
